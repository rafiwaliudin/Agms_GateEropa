...
class CreateHistoryGatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(Schema::hasTable('history_gates')) return; 
        Schema::create('history_gates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('history_gates');
    }
}
