...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Ubah Data Gate</h4>
                <p class="card-title-desc">Lengkapi form dibawah dan klik tombol submit untuk mengganti data
                    gate</p>

                <form action="{{route('admin.residential-gate.update',  $residentialGate->id)}}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('name')) is-invalid @endif"
                            placeholder="Nama" name="name" value="{{$residentialGate->name}}" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('longitude')) is-invalid @endif"
                            placeholder="Longitude" name="longitude" value="{{$residentialGate->longitude}}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('latitude')) is-invalid @endif"
                            placeholder="Latitude" name="latitude" value="{{$residentialGate->latitude}}" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control @if ($errors->has('cluster')) is-invalid @endif"
                            ...
                            <option value="{{$cluster->id}}" @if($cluster->area_id == $cluster->id) selected @endif>
                                {{$cluster->name}}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control @if ($errors->has('phone')) is-invalid @endif"
                            placeholder="Phone Number" name="phone" id="phonefield" value="{{$residentialGate->phone}}">
                        @if ($errors->has('phone'))
                        <span class="text-danger">
                            {{ $errors->first('phone') }}
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('ip_mata')) is-invalid @endif"
                            placeholder="IP Mata" name="ip_mata" value="{{$residentialGate->ip_mata}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('ip_dc_data')) is-invalid @endif"
                            placeholder="IP Data" name="ip_dc_data" value="{{$residentialGate->ip_dc_data}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('ip_dc_image')) is-invalid @endif"
                            placeholder="IP Data Image" name="ip_dc_image" value="{{$residentialGate->ip_dc_image}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('ip_mysql')) is-invalid @endif"
                            placeholder="IP Mysql" name="ip_mysql" value="{{$residentialGate->ip_mysql}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('ip_mongo')) is-invalid @endif"
                            placeholder="IP Mongo" name="ip_mongo" value="{{$residentialGate->ip_mongo}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('ip_dvr')) is-invalid @endif"
                            placeholder="IP DVR" name="ip_dvr" value="{{$residentialGate->ip_dvr}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('port_mata')) is-invalid @endif"
                            placeholder="PORT Mata" name="port_mata" value="{{$residentialGate->port_mata}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('port_dc_data')) is-invalid @endif"
                            placeholder="PORT Data" name="port_dc_data" value="{{$residentialGate->port_dc_data}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('port_dc_image')) is-invalid @endif"
                            placeholder="PORT Data Image" name="port_dc_image"
                            value="{{$residentialGate->port_dc_image}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('port_mysql')) is-invalid @endif"
                            placeholder="PORT Mysql" name="port_mysql" value="{{$residentialGate->port_mysql}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('port_mongo')) is-invalid @endif"
                            placeholder="PORT Mongo" name="port_mongo" value="{{$residentialGate->port_mongo}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @if ($errors->has('port_dvr')) is-invalid @endif"
                            placeholder="PORT DVR" name="port_dvr" value="{{$residentialGate->port_dvr}}">
