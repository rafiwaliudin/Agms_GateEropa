        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Cluster</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-item">
                            <a href="{{route('admin.cluster.create')}}" type="button"
                               class="btn btn-info btn-lg waves-effect waves-light float-right">Tambah
                                Cluster
                            </a>
                        </div>
                        <div class="table-responsive">
                            <table id="table-cluster" class="display nowrap" style="width:100%">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                            ...
                            @include('Partials.loading', ['idLoading' => 'loadingClusterListTable','height' => 330])
                        </div>
