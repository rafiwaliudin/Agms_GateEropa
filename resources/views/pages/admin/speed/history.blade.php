        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Speed History</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">AGMS</a></li>
                                <li class="breadcrumb-item active">Speed History</li>
                            </ol>
                        </div>
                </div>
            </div>
                            ...
                            <div>
                                <div class="input-daterange input-group" data-provide="datepicker">
                                    ...
                                    <div class="input-group-append ml-2">
                                        <button onclick="peopleCountingHistoryTable()" id="search" class="btn btn-info">search</button>
                                    </div>
                                </div>

                            </div>
                            <label style="margin-top: 12px">Export File</label>
                            <div>
                                <div class="input-daterange input-group" data-provide="datepicker">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="people-counting-table" class="display nowrap" style="width:100%">
                                <thead>
                                <tr>
                                    <th scope="col" style="width: 60px;">No</th>
                                    <th scope="col">Photo</th>
                                    <th scope="col">Plat Nomor</th>
                                    <th scope="col">Speed Detected</th>
                                    <th scope="col">Timestamp</th>
                                </tr>
                                </thead>
                                <tbody></tbody>
                            </table>
                            @include('Partials.loading', ['idLoading' => 'loadingSpeedHistoryTable', 'height' => 330])
                        </div>
                    </div>
                </div>
            </div> <!-- end col -->
