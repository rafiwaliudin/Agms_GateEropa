        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">People Counting History</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            @include('Partials.loading', ['idLoading' => 'loadingPeopleCountingHistoryListTable', 'height' => 330])
                        </div>
                    </div>
                </div>
            </div> <!-- end col -->
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            peopleCountingHistoryTable();
            $('#loadingPeopleCountingHistoryListTable').show();
        });
    </script>
