        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Intruder Counting History</h4>
                            ...
                            <div>
                                <div class="input-daterange input-group" data-provide="datepicker">
                                    ...
                                    <div class="input-group-append ml-2">
                                        <button onclick="intruderCountingHistoryTable()" id="search" class="btn btn-info">search</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="intruder-counting-table" class="display nowrap" style="width:100%">
                                <thead>
                                <tr>
                            ...
                            @include('Partials.loading', ['idLoading' => 'loadingIntruderHistoryListTable', 'height' => 330])
                        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            intruderCountingHistoryTable();
            $('#loadingIntruderHistoryListTable').show();
        });
    </script>
@endsection
