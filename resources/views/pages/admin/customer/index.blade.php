                            ...
                            <div>
                                <div class="input-daterange input-group" data-provide="datepicker">
                                    ...
                                    <div class="input-group-append ml-2">
                                        <button onclick="allCustomerTable()" id="search" class="btn btn-info">search</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="customer-table" class="display nowrap" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Age</th>
                                    <th scope="col">Wear Mask</th>
                                    <th scope="col">Detected Duration</th>
                                    <th scope="col">Detected Gaze Duration</th>
                                </tr>
                                </thead>
                            </table>
                            @include('Partials.loading', ['idLoading' => 'loadingCustomerListTable', 'height' => 330])
                        </div>
